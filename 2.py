...
player1 = input('✏️  Введите имя первого игрока: ')
player2 = input('✏️  Введите имя второго игрока: ')
value = 221
priority = randint(0, 2)
if priority:
    print(f'🎲 По итогам жеребьёвки первым ходит игрок по имени {player1}!')
else:
    print(f'🎲 По итогам жеребьёвки первым ходит игрок по имени {player2}!')
